...
<div class='menu'>
<?php include("../menu_zone_management_include.php"); ?>
...
<form action='edit_zone_process.php' method='post'>
<table>
<tr><td>ZONE TO EDIT</td> <td><?php include("../dashboard/list_groups.php") ?></td></tr>
<tr><td>NEW ZONE NAME</td> <td><input type='text' width='64' maxlength='64' id='zone_name' name='zone_name' placeholder='ZONE_NAME'/></td></tr>

<tr><td>NEW ICON</td> <td><?php include("../dashboard/list_icons.php") ?></td></tr>
<tr><td>SHOW IN SIDEBAR</td> <td><input type='checkbox' id='show_sidebar' name='show_sidebar' /></td></tr>
