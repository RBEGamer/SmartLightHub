...
<form action='add_zone_process.php' method='post'>
<table>
<tr><td>ZONE NAME</td> <td><input type='text' width='64' maxlength='64' id='zone_name' name='zone_name' placeholder='ZONE_NAME'/></td></tr>
