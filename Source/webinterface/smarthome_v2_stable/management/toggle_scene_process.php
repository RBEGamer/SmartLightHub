...
$log_update = mysql_query("INSERT INTO `log`(`message`) VALUES ('Toggle Scene: ".$_POST['scene_id']." BY USER')");



$fetchinfo_dev11 = mysql_query("SELECT * FROM `scene_states` WHERE `scene_id`='".$_POST['scene_id']."'");
