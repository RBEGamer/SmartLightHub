...
xmlhttp5.open("POST","/smarthome_v2/help/delete_log.php",true);
...
<br>
<input type="button" value="DELETE LOG" onclick="delete_log()" />
<br><br>
...
$counter = 0;
$result = "";
$fetchinfo_dev = mysql_query("SELECT * FROM `log` WHERE 1");
while($row_dev = mysql_fetch_array($fetchinfo_dev)) {
	 $counter++;
	 $result = $result . $counter .") Time : " .$row_dev['time'] ." -> " .$row_dev['message'];
	 $result = $result ."<br>";
